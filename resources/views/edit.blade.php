                        ...
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="contact-form">
                                    <form action="" name="editBook" id="editBook" method="post">
                                        @csrf
                                        <div class="form-group mb-4 pb-2">
                                            <label for="title" class="form-label">Title</label>
                                            <input value="{{ old('title',$book->title) }}" name="title" type="text" class="form-control shadow-none" id="title">
                                            <p></p>
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="author" class="form-label">Author</label>
                                            <input value="{{ old('author',$book->author) }}" name="author" type="text" class="form-control shadow-none" id="author">
                                            <p></p>
                                        </div>
                                        <div class="form-group mb-4 pb-2">
                                            <label for="description" class="form-label">Description</label>
                                            <textarea name="description" class="form-control shadow-none " id="description" rows="3">{{ old('description',$book->description) }}</textarea>
                                            <p></p>
                                        </div>
                                        <div class="form-group mb-4 pb-2">
...
@section('script')
    <script type="text/javascript">
        $("#editBook").submit(function (e) { 
            ...
            $.ajax({
                type: "PUT",
                url: '{{ route("form.update",$book->id) }}',
                data: $("#editBook").serializeArray(),
                dataType: "json",
                headers : {
